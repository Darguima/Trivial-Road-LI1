module Gloss_Functions.DesenhaEstados.DesenhaBot where
...
desenhaEstadoBot :: Estado -> IO Picture
desenhaEstadoBot (Jogo (Jogador (posX, posY)) mapa, texturas, tamanhoJanela, _, pontuacaoAtual, pontuacoes, larguraMapa, frameAtual,y) = do
  return $ Pictures $ 
