...
reageTempoBot _ (jogo, texturas, tamanhoJanela, paginaAtual, pontuacaoAtual, pontuacoes, larguraMapa, 1,ypontos) = do
      ...
      let novoJogo = animaMapa jogo
         ...
         -- novoMenu = if jogoTerminou novoJogoDeslize then DERROTA else BOT
          

      return (novoJogoDeslize, texturas, tamanhoJanela, BOT, pontuacaoAtual, pontuacoes, larguraMapa, 0,ypontos+1)
...
reageTempoBot _ (jogo, texturas, tamanhoJanela, paginaAtual, pontuacaoAtual, pontuacoes, larguraMapa, frameAtual,ypontos) = do
  ...
  let novoJogo = animaMapa jogo
      novoEstadoBot =  moveBot (novoJogo , texturas, tamanhoJanela, paginaAtual, pontuacaoAtual, pontuacoes, larguraMapa, 1,ypontos)
      novoJogoBot = getJogo novoEstadoBot
      --novoMenu = if jogoTerminou novoJogo then DERROTA else BOT

  return (novoJogoBot, texturas, tamanhoJanela, BOT, pontuacaoAtual, pontuacoes, larguraMapa, frameAtual+1,ypontos)